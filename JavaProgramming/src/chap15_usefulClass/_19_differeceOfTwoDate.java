...
public class _19_differeceOfTwoDate {
	...
	public static void main(String[] args) {
		...
		long year2 = diff / ((long) 1000 * 60 * 60 * 24 * 30 * 12);
		long month2 = diff % ((long) 1000 * 60 * 60 * 24 * 30 * 12) / ((long) 1000 * 60 * 60 * 24 * 30);
		long date2 = diff % ((long) 1000 * 60 * 60 * 24 * 30 * 12) % ((long) 1000 * 60 * 60 * 24 * 30) / (1000 * 60 * 60 * 24);
		long hour2 =diff % ((long) 1000 * 60 * 60 * 24 * 30 * 12) % ((long) 1000 * 60 * 60 * 24 * 30) % (1000 * 60 * 60 * 24) / (1000 * 60 * 60);
		long minute2 =diff % ((long) 1000 * 60 * 60 * 24 * 30 * 12) % ((long) 1000 * 60 * 60 * 24 * 30) % (1000 * 60 * 60 * 24) % (1000 * 60 * 60) / (1000 * 60 );
		System.out.println(year2 + " " + month2 + " " + date2 + " " + hour2 + " " + minute2);
		...
		System.out
				.println(year + "년 " + month + "달 " + date + "일 " + hour + "시간 " + minute + "분 " + second + "초 지났습니다.");
	}
